...
import io.github.kshulzh.kefir.model.ir.arg.wrapIrArguments
...
class KtIrAnnotationElement(
    ...
    override var arguments: MutableList<KtArgumentElement> = wrapIrArguments(
        irElement.symbol.owner.parameters,
        irElement.arguments,
        this,
        transformContext
    ).toMutableList()
