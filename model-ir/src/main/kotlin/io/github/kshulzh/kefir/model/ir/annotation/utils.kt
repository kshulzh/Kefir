...
fun wrapIrAnnotations(
    annotations: List<IrConstructorCall>,
    transformContext: KtTransformContext,
    annotationScope: KtAnnotationsScope? = null
): MutableList<KtAnnotationElement> {
    return annotations.map { KtIrAnnotationElement(it, transformContext, annotationScope) }.toMutableList()
}
