...
tasks.jar {
    archiveBaseName.set("kefir-ir-helper")
}

mavenPublishing {
    publishToMavenCentral(false)
    coordinates(group.toString(), "ir-helper", version.toString())

    pom {
        name = "Kefir IR helper module"
        description = "Module contains ir based wrappers for ir compatibility"
        inceptionYear = "2026"
